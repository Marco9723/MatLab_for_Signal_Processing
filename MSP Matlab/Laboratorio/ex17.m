...
% fill the signal with zeros until reaching N samples
y_tilde = zeros(1, N);
y_tilde(1:length(y)) = y;

% repmat: dimension of y_tilde should be: 1*num_rows(y_tilde), 3*num_cols(y_tilde)
y_tilde = repmat(y_tilde, 1, 3);
